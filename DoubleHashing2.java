...
//         * */
       ...
       ArrayList<HashNode> rehashLarger()
       {
           ArrayList<HashNode> larger=new ArrayList <>();
           int newSize=getPrime(capacity)+capacity;
           for (int i = 0; i < newSize; i++)
               larger.add(null);
           for (int i = 0; i < capacity; i++)
               larger.add(hashTab.get(i));
     ...
     void rehashLarger2()
        ...
        void rehashSmaller()
        {
            ArrayList<HashNode> smaller=new ArrayList <>();
            int newSize=getPrime(capacity/2);
            for (int i = 0; i < newSize; i++)
                smaller.add(null);
            for (int i = 0; i < capacity; i++)
                smaller.add(hashTab.get(i));
...
//                hashTab=rehashLarger();
    ...
    static int getPrime(int TABLE_SIZE)
    {
...
//            if(avgProbes>2) ht.rehashLarger2();
//            if(avgProbes>2) ht.rehashLarger2();
            int tempProbe=0;
            while(avgProbes>2)
            {
                ...
                {
                    int l = (r.nextInt() % strings.size() + strings.size()) % strings.size();
                    tempProbe += ht.Search(strings.get(l));
                }
                tempProbe/=totalNUmberOfStrings;
                avgProbes=tempProbe;
            }
            //if(avgProbes>2) ht.rehashLarger2();
...
//                {
//                    int l = (r.nextInt() % strings.size() + strings.size()) % strings.size();
//                    tempProbe2 += ht.Search(strings.get(l));
//                }
//                tempProbe2/=totalNUmberOfStrings;
//                avgProbes=tempProbe2;
//            }
            if(avgProbes>2)ht.rehashLarger2();
