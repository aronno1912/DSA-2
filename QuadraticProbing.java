...
//            return h;
        ...
        public int Search(String key) {
            ...
            /** we need to use the following hash function for quadratic probing
             *
             *         h(k, i) = (h1(k) + c1*j + c2*j^2) mod N
             * */
            for (int i = 0; i < capacity; i++)
            {
                int u = (int) ((hash1+ c1*i + c2 * i * i) % capacity);
                HashNode head = table.get(u);

                if (head == null) continue;
                if (head.key == key)
                {
                    break; //returns the number of probes
        ...
        public void insert(String key, int value) {
          ...
          /** we nned to use the following hash function for quadratic probing
           *
           *         h(k, i) = (h1(k) + c1*j + c2*j^2) mod N
           * */
            for (int i = 0; i < capacity; i++)
    ...
    public static void main(String[] args) {
        ...
        System.out.println("FOR QUADRATIC PROBING");
        System.out.println();
        for(int j=0;j<=5;j++)
        {
